...
// This splits heavy dependencies like 'recharts' (Dashboard) and 'pptxgenjs' (Workspace)
// into separate chunks, significantly improving initial load time (TTI).
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          <Suspense fallback={<div className="flex items-center justify-center h-64 text-slate-400">Loading module...</div>}>
