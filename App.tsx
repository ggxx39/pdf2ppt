...
// ⚡ Bolt: Implement route-level code splitting to dynamically load heavy dependencies
// like pptxgenjs and recharts only when their respective tabs are active,
// significantly reducing the initial JavaScript bundle size and load time.
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          <Suspense fallback={<div className="flex items-center justify-center h-full text-slate-500 py-12">Loading module...</div>}>
