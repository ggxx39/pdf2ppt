  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          {/* ⚡ Bolt: Implemented code splitting to dynamically load heavy dependencies (recharts, pptxgenjs) only when needed, reducing initial bundle size significantly */}
          <React.Suspense fallback={<div className="flex items-center justify-center h-full py-12 text-slate-400">Loading module...</div>}>
