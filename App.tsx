...
// ⚡ Bolt: Route-level code splitting to defer loading of heavy dependencies (recharts, pptxgenjs)
// and significantly reduce the initial JS bundle size.
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          <React.Suspense fallback={<div className="flex items-center justify-center h-full text-slate-500">Loading component...</div>}>
