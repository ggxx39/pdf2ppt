...
// Optimization: Dynamically import heavy route components (Dashboard with Recharts,
// Workspace with PptxGenJS) to significantly reduce the initial bundle size
    ...
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8 h-full">
          {/* Optimization: Wrap lazy-loaded components in Suspense to show a fallback while loading chunks */}
          <Suspense fallback={<div className="flex h-full items-center justify-center p-8 text-slate-400">Loading module...</div>}>
