...
// Dynamically import components to code-split heavy dependencies like recharts and pptxgenjs
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          <Suspense fallback={<div className="flex items-center justify-center h-full p-12 text-slate-500">Loading module...</div>}>
