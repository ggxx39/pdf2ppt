...
// ⚡ Bolt: Code split heavy tab components to reduce initial bundle size
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          <React.Suspense fallback={<div className="flex justify-center items-center h-64 text-slate-500">Loading...</div>}>
