...
// Lazy load heavy components to reduce initial bundle size and defer loading dependencies
// like recharts and pptxgenjs until their respective tabs are activated.
