...
// Using React.lazy to code-split heavy tab components (like Workspace with pptxgenjs and Dashboard with recharts)
// Impact: Significantly reduces the initial main bundle size and improves initial load time.
