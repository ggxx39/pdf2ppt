...
// Dynamically import tab components to reduce the initial bundle size (from ~1.25MB to ~207KB).
// This defers loading heavy dependencies like pptxgenjs and recharts until their respective tabs are opened.
