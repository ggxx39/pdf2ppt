...
// ⚡ Bolt Optimization: Dynamically import heavy route components using React.lazy.
// This splits the bundle, preventing users from downloading the full application
// code (including heavy libraries like recharts and pptxgenjs) until they navigate
// to the respective tab, improving initial load times.
