...
// ⚡ Bolt: Dynamically importing tab components to code-split heavy dependencies (Recharts, PPTXGenJS)
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          <Suspense fallback={<div className="flex items-center justify-center p-12 text-slate-500">Loading component...</div>}>
