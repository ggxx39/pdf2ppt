...
// ⚡ Bolt: Use React.lazy for code splitting to reduce initial bundle size. Heavy components like Workspace (pptxgenjs) and Dashboard (recharts) are only loaded when needed.
