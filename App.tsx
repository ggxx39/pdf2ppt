  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          {/* Bolt Optimization: Lazy load heavy tab content to reduce initial bundle size */}
          <Suspense fallback={<div className="flex items-center justify-center h-full p-8 text-slate-500 animate-pulse">Loading component...</div>}>
