...
// ⚡ Bolt Optimization: Lazy load route components to reduce initial bundle size and avoid loading heavy libraries (like recharts and pptxgenjs) until needed.
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto flex flex-col relative">
        ...
        <div className="p-8">
          <Suspense fallback={<div className="flex items-center justify-center h-64 text-slate-500 font-mono text-sm animate-pulse">Loading component...</div>}>
